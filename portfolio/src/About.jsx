...
import { FaGithub, FaLinkedin, FaPython, FaJava, FaDocker } from 'react-icons/fa';
    ...
    <nav className="fixed top-0 left-0 right-0 bg-white dark:bg-[#094243] shadow-md z-50 transition-colors duration-200">
        <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
                <a href="/" className="text-2xl md:text-4xl font-bold dark:text-gray-200 hover:text-yellow-600 transition-colors">
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map(({ href, text }) => (
                        <a
                            key={text}
                            href={href}
                            className={`transition-colors ${text === 'About'
            ...
            <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden mt-6 pb-4 border-t border-gray-200 dark:border-gray-700 pt-6`}>
                <div className="flex flex-col space-y-4">
                    {navLinks.map(({ href, text }) => (
                        <a key={text} href={href} className="text-lg py-2 px-4 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" onClick={toggleMobileMenu}>
                            {text}
                        </a>
                    ))}
                </div>
...
const outsideItems = [
    {
        ...
        label: 'Hiking',
        description:
            "Somewhere in the mountains is where I actually decompress. Macedonia has nature and trails that most people don't know exist - I try to make the most of that.",
    },
    {
        emoji: '🏃',
        label: 'Running',
        description:
            'From time to time. Not fast - just a reliable way to clear the head before or after a long day of thinking in code.',
    },
    {
        emoji: '⛷️',
        label: 'Skiing',
        description:
            "Look forward ot it every winter.",
    },
    {
        emoji: '🧗',
        label: 'Rock Climbing',
        description:
            "Tried it and liked it more than expected. It's basically puzzle-solving where your body and mind must work together.",
    },
    {
        emoji: '🏕️',
        label: 'Camping',
        description:
            "I love being outside properly - no signal, sleeping under stars, waking up cold. It resets something that a weekend at home doesn't.",
    },
];
...
const BitolaSection = () => (
    <div className="mt-16 p-8 bg-white dark:bg-[#073031] rounded-2xl shadow-lg border-l-4 border-yellow-500">
        <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">
            Bitola<span className="text-yellow-600">.</span>
        </h3>
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
                I grew up in Bitola - a city in the south of Macedonia that most people have never heard of
                but once they visit it, they certainly find it as one of the most beautiful towns they've seen.
                It's a small city with Roman ruins in the middle of it (Heraclea Lyncestis, if you want to look it up),
                a long main street where everyone seems to know everyone, and a pace of life that's genuinely
                one of a kind.
            </p>
            <p>
                I did my first competitions there - mathematics, physics, informatics. The teachers who pushed
                me were from Bitola. The habits that got me through university and are still with me were formed there.
            </p>
            <p>
                Pelister National Park is right next to the city. That's partly why hiking became a thing
                for me - it was the obvious weekend option growing up. I still go back when I can.
            </p>
        </div>
    </div>
);
            ...
            <div className="min-h-screen bg-white dark:bg-[#094243] text-gray-900 dark:text-white transition-colors duration-200">
                ...
                <div className="pt-32 pb-16 bg-gradient-to-br from-gray-50 via-blue-50 to-yellow-50 dark:from-[#094243] dark:via-[#0a4748] dark:to-[#0b4a4c]">
                    <div className="container mx-auto px-4 max-w-3xl">
                        <p className="text-yellow-600 dark:text-yellow-400 font-semibold tracking-widest text-sm uppercase mb-4 fade-up">
                            The full picture
                        </p>
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed fade-up delay-2">
                            Software engineer, researcher, and someone who spends a lot of time in the mountains
                            when not in front of a screen.
                        </p>
                    </div>
                </div>
                ...
                <section className="py-16 border-b border-gray-100 dark:border-gray-800">
                    <div className="container mx-auto px-4 max-w-3xl">
                        <h2 className="text-3xl font-bold mb-8 fade-up">
                            The work<span className="text-yellow-600">.</span>
                        </h2>
                        <div className="space-y-5 text-lg text-gray-700 dark:text-gray-300 leading-relaxed fade-up delay-1">
                            <p>
                                I'm a software engineer at ITQuarks in Skopje, where I build AI systems that are
                                meant to run in production - not demos, not notebooks, but things that operate in
                                the background and do something useful. Right now that's a multi-agent platform for
                                document understanding and compliance automation.
                            </p>
                            <p>
                                Before that I built the backend for an AI investing platform: a Strands Agents
                                orchestrator that monitors users' portfolios continuously and sends personalised
                                insights without them having to ask.
                            </p>
                            <p>
                                I've been here for more than two years now, and there hasn't been a dull moment or project yet.
                                Something new to learn and figure out every week, and a lot of freedom to do it in the way that makes the most sense to me.
                            </p>
                            <p>
                                I also spent time at the Macedonian Academy of Sciences doing research
                                and buidling a hybrid RAG system for neurology literature that
                                combined keyword search, dense embeddings, and knowledge graphs.
                            </p>
                            <p>
                                I'm currently in the MSc Data Science programme at FCSE where I'm doing neuroimaging
                                research: classifying brain tumours, MS lesions, and stroke from MRI/CT
                                scans using a LangGraph pipeline with task-specific CNNs, BiomedCLIP and SAM3 segmentation.
                            </p>
                            <p>
                                I finished my BSc with a 9.72/10 GPA, ranked among the top students all four years.
                                I mention it not to brag but because doing that while working and doing research in
                                parallel taught me more about prioritisation than any course specifically designed to.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 border-b border-gray-100 dark:border-gray-800">
                    <div className="container mx-auto px-4 max-w-3xl">
                        <h2 className="text-3xl font-bold mb-4 fade-up">
                            Outside of work<span className="text-yellow-600">.</span>
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-10 text-lg fade-up delay-1">
                            I spend as much time as I can outdoors. Nature genuinely recharges me in a way
                            that nothing indoors quite replicates.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {outsideItems.map((item, i) => (
                                <div
                                    key={i}
                                    className="p-6 bg-white dark:bg-[#073031] rounded-xl shadow-md hover-lift border border-transparent hover:border-yellow-400 dark:hover:border-yellow-600 transition-all duration-300 fade-up"
                ...
                <section className="py-16 border-b border-gray-100 dark:border-gray-800">
                    <div className="container mx-auto px-4 max-w-3xl">
                        <h2 className="text-3xl font-bold mb-6 fade-up">
                            On learning<span className="text-yellow-600">.</span>
                        </h2>
                        <div className="space-y-4 text-lg text-gray-700 dark:text-gray-300 leading-relaxed fade-up delay-1">
                            <p>
                                I genuinely enjoy learning - not in a LinkedIn-caption way, but in the sense that
                                finding out how something works is its own reward for me. That's probably why I
                                getting the Bachelor's degree did not mean the end of the education course for me, alongside
                                having a full-time job. It's also why I entered hackathons and competitions all throughout
                                primary and high school and continued in university: not for the prizes (though winning
                                them brings great satisfaction as well), but because constrained problems force you to learn fast.
                            </p>
                            <p>
                                The things I'm most interested in right now are at the intersection of ML and
                                medicine - where the stakes make the accuracy numbers mean something real. And
                                multi-agent systems, because I think we're still in the early innings of figuring
                ...
                <section className="py-16">
                    <div className="container mx-auto px-4 max-w-3xl">
                        <h2 className="text-3xl font-bold mb-6 fade-up">
                            Where I'm from<span className="text-yellow-600">.</span>
                        </h2>
                        <BitolaSection />
                    </div>
                </section>
