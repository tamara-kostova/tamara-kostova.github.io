...
const About = () => <div className="about-page">
  ...
  <main className="about-shell">
    <section className="about-hero"><div className="about-hero-text"><h1><span>The longer</span><i>version.</i></h1><p>Software engineer, researcher, and someone who spends a lot of time in the mountains when not in front of a screen.</p></div><figure className="about-portrait"><img src="/assets/img/me-portrait.jpg" width="900" height="1125" alt="Tamara Kostova" /><figcaption>Skopje, 2025</figcaption></figure></section>
